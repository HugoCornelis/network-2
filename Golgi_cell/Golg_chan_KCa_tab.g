// nog te doen : Temp en ZF verwijderen ?
// genesis

int include_golg_chan_KCa_tab

if ( {include_golg_chan_KCa_tab} == 0 )

	include_golg_chan_KCa_tab = 1
...
function make_Moczyd_KC
	...
	call Moczyd_KC TABREAD ../Golgi_cell/tabKCa37.data
